...
public class AIObjects
{
    ...
    [SerializeField]
    [Range(0f, 10f)] private int m_maxSpawnAmount;

    [Header("Main Settings")]
    [SerializeField] private bool m_enableSpawner;
    [SerializeField] private bool m_randomizeStats;
...
public class FishSpawner : MonoBehaviour
{
    ...
    [SerializeField] private Color m_SpawnColor = new Color(1.000f, 0.000f, 0.300f);
    [SerializeField] private Vector3 m_SpawnArea = new Vector3(20f, 10f, 20f);
            ...
            if(AIObject[i].enableSpawner && AIObject[i].objectPrefab != null)
            {
                ...
                if(tempGroup.GetComponentInChildren<Transform>().childCount < AIObject[i].maxAI)
                {
                    for(int y = 0; y < Random.Range(0, AIObject[i].spawnAmount); y++)
                    {
                        ...
                        //tempSpawn.AddComponent<FishMovement>();
                    }
                }
            }
        }
